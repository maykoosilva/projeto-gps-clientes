...
COPY public.cidade (cod_cidade, descricao) FROM stdin;
1	São Paulo
2	Rio de Janeiro
\.
...
COPY public.clientes (id, razao_social, nome_fantasia, endereco, end_numero, cep, cod_cidade, cnpj_cpf, ativo, cod_repres) FROM stdin;
...
3	Auto Peças Brasil	Auto Parts BR	Rua C	789	34567-000	1	567890120001	S	53
\.
...
COPY public.representante (cod_repres, razao) FROM stdin;
53	João Silva
\.
